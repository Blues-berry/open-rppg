const INPUT_COUNT = 48, IMG_IDX = 1, DT_IDX = 0, IMG_SHAPE = [1, 1, 36, 36, 3], BUFFER_SIZE = 450;
...
let LiteRT, Tensor, model, sqiModel, psdModel, inputs = [], initialState = {}, bvp = new Float32Array(BUFFER_SIZE), cursor = 0, samples = 0, elapsed = 0, lastAnalysis = 0;
// This is intentionally a classic Worker: @litertjs/core 0.2.1 loads its
// Emscripten glue with importScripts(), which Edge rejects in module Workers.
